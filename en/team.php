...
<body>
    <div id="wrapper">
        ...
        <picture>
            ...
            <img src="../img/avocats-7-mob.jpg" alt="Isabelle Guyader Dousset and Claire Dousset" class="image">
        </picture>
        ...
        <section>
            <article id="equipe">
                ...
                <div class="portrait">
                    <img src="../img/portrait-isa-2.jpg" alt="Isabelle Guyader Dousset" class="photoID" id="portrait-isa">
