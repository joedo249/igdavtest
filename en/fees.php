...
<body>
    <div id="wrapper">
        ...
        <picture>
            ...
            <img src="../images_igdav/bureau-7-mob.jpg" alt="office of Isabelle Guyader Dousset" class="image">
        </picture>

        <section>
            <aside>
               <img src="../images_igdav/logo-avocats-paris" alt="ordre des avocats Paris" id="avocats_paris">
            </aside>
