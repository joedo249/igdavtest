    ...
    <img src="images_igdav/retour-haut-bleu.png" alt="Retour haut" id="returnOnTop">
    ...
    <!-- Pied de la page -->    
        <footer>
            <div class="navfooter"> 
                <ul>
                    ...
                    <li>
                        <a id="boxsitemap" data-fancybox data-src="#modal" href="javascript:;">Plan du site</a>
                    </li>
                    <li>
                        <a id="boxml" data-fancybox data-animation-duration="700" data-src="#animatedModal" href="javascript:;">Mentions légales</a>
                    </li>
                </ul>
            </div>
        </footer>
        ...
        <!-- Animated fancyBox 
            ================== -->
        <!-- source du code : https://codepen.io/fancyapps/pen/OOXxLa -->
        ...
        <div style="display: none;" id="animatedModal" class="animated-modal">
            ...
            A ce titre et conformément au Code de la Propriété Intellectuelle seule l'utilisation pour un usage privé dans un cercle de famille est autorisée et toute autre utilisation est constitutive de contrefaçon et/ou d'atteinte aux droits voisins, sanctionnées par ledit Code.<br><br> 
        ...
        <!-- bouton Fermer -->
            <p><button data-fancybox-close class="btn">Fermer</button></p>
        </div>
