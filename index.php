...
<head>
  ...
  <meta http-equiv="Content-Security-Policy" content="default-src 'self' script-src 'self' img-src 'self' style-src 'self' 'unsafe-inline' 'unsafe-eval' script-src 'strict-dynamic' https://ajax.googleapis.com">
