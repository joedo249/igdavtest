...
<head>
    <meta charset="UTF-8">
    <title>IGD Avocats garantit une transparence totale sur le montant des honoraires.</title>
...
<body>
    <div id="wrapper">
        ...
        <picture>
            <source media="(max-width: 479px)" srcset="images_igdav/bureau-7-mob.jpg">
            <source media="(min-width: 480px)" srcset="images_igdav/bureau-7.jpg">          
            <img src="images_igdav/bureau-7-mob.jpg" alt="bureau d'Isabelle Guyader Dousset" class="image">
        </picture>

        <section>
            <aside>
               <img src="images_igdav/logo-avocats-paris.jpg" alt="ordre des avocats Paris" id="avocats_paris">
            </aside>
